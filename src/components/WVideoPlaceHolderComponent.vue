<template>
  <div class="relative overflow-hidden rounded-lg" :class="border">
    ...
    <div v-if="topLeftText" class="absolute top-4 left-4 text-[#EDEDED] text-[13px] drop-shadow-lg">
      {{ topLeftText }}
    </div>

    <div
      v-if="topRightText"
      class="absolute top-4 right-4 text-white/60 text-[13px] drop-shadow-lg"
    >
      {{ topRightText }}
    </div>
    ...
    <div
      v-if="bottomLeftText"
      class="absolute bottom-4 left-4 text-[#EDEDED] text-[13px] drop-shadow-lg"
    >
      {{ bottomLeftText }}
    </div>
    ...
    <div
      ...
      class="absolute bottom-4 right-4 text-white/60 text-[13px] drop-shadow-lg"
    >
      {{ bottomRightText }}
    </div>
  </div>
